...
<html><head>
  ...
  <body id="pakarayam" class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b><i class="" aria-hidden="true"></i>Sistem Pakar</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="" aria-hidden="true"></i>Sistem Pakar </b></span>
        </a>
        <!-- Header Navbar -->
                ...
                if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="gambar/admin/admin12.png" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?>
                      <span class="hidden-xs"><?php echo $user; ?></span>
                    </a>
                    <ul class="dropdown-menu">
                      <!-- User image -->
                      <li class="user-header">
                        <img src="gambar/admin/admin12.png" class="img-circle" alt="User Image">
                        <p>
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2023 - </i> Aji Setiawan</a></div></strong>
      </footer>
